...
/**
 * Bleibt bewusst ein POST: als Redirect-Endpoint verloere er seinen CSRF-Schutz – eine
 * Navigation kann X-Requested-With nicht tragen, und jede fremde Seite koennte deine
 * User per <img src> ausloggen. Die End-Session-URL kommt darum als JSON zurueck.
 *
